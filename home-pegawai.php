...
<body class="hold-transition skin-red fixed sidebar-mini">
  ...
  <div class="wrapper">
    <header class="main-header">
      <a href="home-pegawai.php" class="logo" style="background-color:#BAC4FE">
        ...
        <ul class="sidebar-menu">
          ...
          if ($query && mysqli_num_rows($query) > 0) {
            ...
            if ($numRows > 0) {
              ...
              echo "<li class='treeview'><a href='home-pegawai.php?page=approval-cuti'><i class='fa fa-gear'></i> <span>Approval Cuti</span></i></a>";
            }
          }
          ?>
        </ul>
