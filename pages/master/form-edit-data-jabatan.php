...
$jabatan = mysqli_query($con, "SELECT * from tb_jabatan WHERE id='$id'");
$hasil = mysqli_fetch_array($jabatan);
$id = $hasil['id'];
?>
<section class="content-header">
    <h1>Form<small>Edit Data Jabatan </small></h1>
    <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                <form action="home-admin.php?page=edit-data-jabatan&id=<?= $id ?>" class="form-horizontal" method="POST" enctype="multipart/form-data">
                    <div class="box-body">
