...
$pegawai = mysqli_query($con, "SELECT * from tb_users WHERE soft_delete = '0'");
?>
						...
						?>
							<tr>
								...
								<td class="tools">
									...
									&nbsp;&nbsp;&nbsp;&nbsp;
									<a href="home-admin.php?page=reset-cuti&nik=<?php echo $peg['nik']; ?>" title="reset cuti"><i class="fa fa-refresh"></i></a>
								</td>
							</tr>
						<?php
						}
