...
<?php	
	...
	$cekuser	=mysqli_num_rows (mysqli_query($con,"SELECT id_user FROM tb_users WHERE id_user='$_POST[id_user]'"));
		...
		$insert = "INSERT INTO tb_users (id_user, nama_user, password, hak_akses, aktif) VALUES ('$id_user', '$nama_user', '$password', '$hak_akses', 'Y')";
