<section class="content-header">
    <h1>Delete<small>Data Jenis Cuti</small></h1>
    <ol class="breadcrumb">
        <li><a href="home-admin.php"><i class="fa fa-dashboard"></i>Dashboard</a></li>
        <li class="active">Delete Data Jenis Cuti</li>
    </ol>
</section>
<div class="register-box">
    ...
    if (isset($_GET['id'])) {
        $id = $_GET['id'];
        $query   = "SELECT * FROM tb_jeniscuti WHERE id='$id'";
    ...
    if (!empty($id) && $id != "") {
        $delete = "DELETE FROM tb_jeniscuti WHERE id='$id'";
