...
<?php
	...
	$tampilCuti=mysqli_query($con,"SELECT * FROM tb_mohoncuti WHERE persetujuan='' ORDER BY tgl DESC");
	$jmlcut=mysqli_num_rows($tampilCuti);
?>
<body class="hold-transition skin-red fixed sidebar-mini">
<div class="wrapper">
	<header class="main-header">
		<a href="home-hrd.php" class="logo"><span class="logo-mini">CUTI</span><span class="logo-lg"><b>Cuti</b> ONLINE</span></a>
